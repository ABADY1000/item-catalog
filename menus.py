...
from DataSetup import Restaurant, Base, MenuItem
...
restaurant1 = Restaurant(name="Urban Burger", user_id=0)
...
menuItem1 = MenuItem(name="Chicken Stir Fry", description="with your choice of noodles vegetables and sauces",
                     price="$7.99", course="Entree", restaurant=restaurant2, user_id=1)
...
menuItem2 = MenuItem(
    ...
    price="$25", course="Entree", restaurant=restaurant2, user_id=1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(name="Spicy Tuna Roll", description="",
                     price="", course="", restaurant=restaurant2, user_id=1)

session.add(menuItem3)
session.commit()

menuItem4 = MenuItem(name="Nepali Momo ", description="",
                     price="", course="", restaurant=restaurant2, user_id=1)

session.add(menuItem4)
session.commit()

menuItem5 = MenuItem(name="Beef Noodle Soup", description="",
                     price="", course="", restaurant=restaurant2, user_id=1)
...
menuItem6 = MenuItem(
    name="Ramen", description="", price="", course="", restaurant=restaurant2, user_id=1)
...
restaurant1 = Restaurant(name="Panda Garden", user_id=2)
...
menuItem1 = MenuItem(name="Pho", description="a Vietnamese noodle soup consisting of broth, linguine-shaped rice noodles called banh pho, a few herbs, and meat.",
                     price="", course="", restaurant=restaurant1, user_id=2)
...
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine ", user_id=3)
...
menuItem1 = MenuItem(name="Tres Leches Cake", description="Rich, luscious sponge cake soaked in sweet milk and topped with vanilla bean whipped cream and strawberries.",
                     price="", course="", restaurant=restaurant1, user_id=3)
...
menuItem3 = MenuItem(name="Honey Boba Shaved Snow", description="Milk snow layered with honey boba, jasmine tea jelly, grass jelly, caramel, cream, and freshly made mochi",
                     price="$23", course="Main", restaurant=restaurant1, user_id=3)
...
menuItem1 = MenuItem(name="Shellfish Tower", description="",
                     price="", course="", restaurant=restaurant1)

session.add(menuItem1)
session.commit()

menuItem2 = MenuItem(name="Chicken and Rice", description="",
                     price="", course="", restaurant=restaurant1)

session.add(menuItem2)
session.commit()

menuItem3 = MenuItem(name="Mom's Spaghetti", description="",
                     price="", course="", restaurant=restaurant1)
...
menuItem4 = MenuItem(name="Nigiri SamplerMaguro, Sake, Hamachi, Unagi, Uni, TORO!",
                     description="", price="", course="", restaurant=restaurant1)
